                    ...
                    <div id="first-scene">
                        <div>
                            ...
                            <input checked="" id="type-all" name="type" type="radio" value="all">
                                ...
                                <input id="type-indiv" name="type" type="radio" value="indiv">
                        ...
                        <div id="customer-div" style="margin-bottom: 16px;display: none;">
                            <input class="form-control" id="customer-text" placeholder="ชื่อหรือรหัสลูกค้า" type="text">
                            </input>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#submit-btn').click(function(){
            ...
            if(type_val === 'all'){
                $('#note-text').val('รายงานสรุปยอดขายระหว่างวันที่ '+ startDate + ' ถึง '+ endDate + '   (ทั้งหมด)');
            }else{
                $('#note-text').val('รายงานสรุปยอดขายระหว่างวันที่ '+ startDate + ' ถึง '+ endDate + '   ('+ $('#customer-text').val() +')');
            }
            $('#modal').modal('show');
        });
